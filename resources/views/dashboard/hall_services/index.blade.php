    ...
    <div class="card card-custom gutter-b">
        <div class="card-header flex-wrap py-3">
            ...
            <div class="card-toolbar">
                <!--begin::Button-->
                <a href="{{ route('dashboard.HallService.create') }}" class="btn btn-primary font-weight-bolder">
        ...
        <div class="card-body">
            ...
            <table class="table table-bordered table-checkable" id="service_tb">
                ...
                <tbody>
                    @foreach ($hall_services as $hall_service)
                    <tr>
                        <td>{{$hall_service->hall->hall_name}}</td>
