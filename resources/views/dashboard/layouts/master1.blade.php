    ...
    <div class="main-wrapper">
        <div class="header">
            <div class="header-left">
                <a href="index.html" class="logo"> <img src="#" width="50" height="70" alt="logo"> <span
                ...
                @if (Auth::check())
                                    ...
                                    <li class="notification-message">
                                        <a href="#">
                                            <div class="media"> <span class="avatar avatar-sm">
                                                ...
                                                <div class="media-body">
                                                    <p class="noti-details"><span class="noti-title">Mercury
                                                            Software
                    ...
                    <li class="nav-item dropdown has-arrow">
                        <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown"> <span
                                class="user-img"><img class="rounded-circle" src="#" width="31"
                                    alt="{{ Auth::user()->name }}"></span> </a>
                        <div class="dropdown-menu">
                            <div class="user-header">
                                <div class="avatar avatar-sm"> <img src="#" alt="User Image"
                                        class="avatar-img rounded-circle"> </div>
                                <div class="user-text">
                                    <h6>{{ Auth::user()->name }}</h6>
                                    <p class="text-muted mb-0">{{ Auth::user()->type }}</p>
                                </div>
                            </div> <a class="dropdown-item" href="{{ route('dashboard.profile') }}">My Profile</a>
                            <a class="dropdown-item" href="settings.html">Account Settings</a> <a
                ...
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        @foreach (config('nav') as $item)
                            <li>
                                <a href="{{ is_callable($item['route']) ? $item['route']() : $item['route'] }}"
                                    class="@if (Route::is($item['route.active'])) active @endif">
                                    <i class="{{ $item['icon'] }}"></i>
                                    <span>
                                        {{ $item['title'] }}
                                        @if (isset($item['badge']))
                                            <span
                                                class="right badge badge-{{ $item['badge']['class'] }}">{{ $item['badge']['label'] }}</span>
                                        @endif
                                    </span>
                                </a>
                            </li>
